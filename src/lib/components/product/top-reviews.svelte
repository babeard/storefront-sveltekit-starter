<script lang="ts">
	import { StarIcon as StarSolidIcon } from '@babeard/svelte-heroicons/solid';
	import { StarIcon as StarOutlineIcon } from '@babeard/svelte-heroicons/outline';
				...
				>
					<div class="flex items-center xl:col-span-1">
						<div class="flex items-center">
							{#each [0, 1, 2, 3, 4] as rating (rating)}
								{#if review.rating > rating}
									<StarSolidIcon class="text-yellow-400 h-5 w-5 flex-shrink-0" aria-hidden="true" />
								{:else}
									<StarOutlineIcon
